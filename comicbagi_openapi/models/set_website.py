...
class SetWebsite(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["host", "name", "redacted"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if redacted (nullable) is None
        # and model_fields_set contains the field
        if self.redacted is None and "redacted" in self.model_fields_set:
            _dict['redacted'] = None
